      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6">
          ...
          <div className="text-center md:text-left">
            <p className="meta mb-2">Overall approval</p>
            {polling.status === "unavailable" ? (
              ...
              <>
                <div className="flex items-baseline justify-center md:justify-start gap-3">
                  <span className="font-serif text-5xl md:text-6xl numeral font-bold tracking-tight text-[#c41e3a]">
                    {polling.disapproval != null ? polling.disapproval.toFixed(0) : "—"}%
                  </span>
                ...
                <div className="mt-1 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-1 text-sm text-[var(--ink-muted)]">
                  {polling.approval != null && (
                    <span>{polling.approval.toFixed(0)}% approval</span>
                  )}
                  {polling.net != null && (
                    <span>
                      Net {polling.net > 0 ? "+" : ""}
          ...
          <div className="text-center border-y md:border-y-0 md:border-x border-[var(--rule)] py-6 md:py-0 md:px-6">
            ...
            <Link href="/archive" className="group block">
              <span className="font-serif text-5xl md:text-6xl numeral font-bold tracking-tight text-[#c41e3a] group-hover:opacity-80 transition-opacity">
        ...
        <div className="mt-10 pt-6 border-t border-[var(--rule)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="font-serif text-3xl numeral font-bold text-[#c41e3a]">
                ${gas.value.toFixed(2)}
